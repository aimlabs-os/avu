...
More details about each of these formats can be found in the [`vue` package README](https://github.com/aimlabs-os/avu/blob/master/packages/vue/README.md#which-dist-file-to-use) and the [Rollup config file](https://github.com/aimlabs-os/avu/blob/master/rollup.config.js).
...
> rollup v1.19.4
> bundles packages/pcka/src/index.ts → packages/pcka/dist/pcka.global.js...
```
...
The `dev-compiler` script builds, watches and serves the [Template Explorer](https://github.com/aimlabs-os/avu/tree/master/packages/template-explorer) at `http://localhost:5000`. This is extremely useful when working on the compiler.
